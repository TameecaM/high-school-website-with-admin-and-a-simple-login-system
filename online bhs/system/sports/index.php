...
<html lang="en">
  ...
  <body >
    ...
    <h1 class="text-center py-4 my-4"><u>Sport list</u></h1>

    <div class="w-50 m-auto">
    <form action="data.php" method="post" autocomplete="off">
        <div class="form-group">
            <label for="subject"><b>sport</b></label>
            <input class="form-control" type="text" name="sport" id="sport" placeholder="Type here to add sport to list" Required>

        </div><br>
        <button class="btn btn-success">Add To sports list</button>
