...
<html lang="en">
  ...
  <body >
    ...
    <h1 class="text-center py-4 my-4"><u>Subject List</u></h1>

    <div class="w-50 m-auto">
    <form action="data.php" method="post" autocomplete="off">
        <div class="form-group">
            <label for="subject"><b>Subject</b></label>
            <input class="form-control" type="text" name="subject" id="subject" placeholder="Type here to add subject to list" Required>

        </div><br>
        <button class="btn btn-success">Add To Subject</button>
